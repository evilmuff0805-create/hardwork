...
If you are using the Codex Supabase MCP integration, authenticate it before asking Codex to inspect or mutate your Supabase project with this command: `codex mcp login supabase`.
