...
A GitHub Actions workflow can run `npm ci`, `npm run typecheck`, and `npm run build` on GitHub-hosted runners. This is often more reliable than the restricted Codex container.

Recommended future workflow file:
